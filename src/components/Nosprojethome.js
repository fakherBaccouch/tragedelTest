...
const testimonials = [
  {
    ...
    quote:
      "Acquisition d’équipements des postes HTA/BT"
  },
  {
   
    image: `${require("../assets/image2.jpg")}`,
    quote:
      "Acquisition, Montage et Installation des lampadaires d’éclairage public en panneaux solaires photovoltaïques"
  },
  {
   
    image: `${require("../assets/image3.jpg")}`,
    quote:
      "éclairage de la ville de Bangui par des lampadaires solaires République Centrafricaine "
  }
];

function Nosprojethome() {
